  ...
  render() {
    ...
    return (h(Host, null,
      ...
      h("div", { class: this.getCssClassMap() },
        ...
        (!!this.helperText || !!this.counter) && (h("div", { class: "text-field__meta", id: helperTextId, "aria-live": "polite", "aria-relevant": "additions removals" }, this.counter && (h("div", { class: "text-field__counter" },
