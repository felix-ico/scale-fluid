  ...
  render() {
    return (h(Host, { onKeyDown: this.handleKeyDown },
      ...
      h("span", { part: "trigger", "aria-describedby": this.componentId },
        h("slot", null)),
      !this.disabled && (h("div", { part: "tooltip", role: "tooltip", "aria-hidden": this.opened ? 'false' : 'true', ref: (el) => (this.tooltipEl = el), id: this.componentId, tabIndex: 0, onMouseOver: this.handleTooltipMouseOver, onMouseLeave: this.handleTooltipBlur },
        h("slot", { name: "content" }, this.content),
        h("div", { part: "arrow", ref: (el) => (this.arrowEl = el) })))));
  }
