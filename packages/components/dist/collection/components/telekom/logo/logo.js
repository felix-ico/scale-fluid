  ...
  render() {
    return (h(Host, { exportparts: "logo-svg" },
      ...
      h("a", { href: this.href, part: this.getCssClassMap(), tabIndex: this.focusable === false ? -1 : 0, onFocus: () => {
        ...
        }, title: this.logoHideTitle ? '' : this.logoTitle, "aria-describedby": this.logoAriaDescribedBy },
        h("scale-logo-svg", { part: "icon", language: this.language, color: this.variant, role: "link", logoTitle: this.logoTitle, logoHideTitle: this.logoHideTitle }))));
  }
  getCssClassMap() {
